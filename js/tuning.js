...
const TUNING_REQUIRED = [
  ...
  'combat.defeatCloutShare', 'combat.staminaPerFight',
  'combat.roundDamageShare', 'combat.damageSpread', 'combat.firstStrikeEdge',
  'combat.runAwayChance',
  'hospital.fullHealSeconds', 'hospital.shieldedWhileHospitalized',
  'hospital.healCost.type', 'hospital.healCost.base', 'hospital.healCost.ratio',
  'crew.cloutPerRecruit', 'crew.lieutenantsPerSlot', 'crew.maxBonusSlotsPerType',
  'crew.slotRotation',
